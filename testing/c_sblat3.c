...
/* Main program */ int MAIN__(void)
{
    ...
    static char snames[12*6] = "cblas_sgemm " "cblas_ssymm " "cblas_strmm " 
	    "cblas_strsm " "cblas_ssyrk " "cblas_ssyr2k";
    ...
    extern /* Subroutine */ int schk1_(char *, real *, real *, integer *, 
	    ...
	    real *, integer *, ftnlen), schk2_(char *, real *, real *, 
	    integer *, integer *, logical *, logical *, logical *, integer *, 
	    integer *, integer *, real *, integer *, real *, integer *, real *
	    , real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, real *, integer *, ftnlen), schk3_(char *, real *, real *,
	     integer *, integer *, logical *, logical *, logical *, integer *,
	     integer *, integer *, real *, integer *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, real *, integer *, ftnlen)
    ...
    extern /* Subroutine */ int cs3chke_(char *, ftnlen);
...
/*           Test error exits. */
	    if (tsterr) {
		cs3chke_(snames + (isnum - 1) * 12, (ftnlen)12);
		s_wsle(&io___75);
		e_wsle();
	    }
/*           Test computations. */
	...
	integer *iorder, ftnlen sname_len)
{
    ...
    extern /* Subroutine */ int sprcn1_(integer *, integer *, char *, integer 
	    *, char *, char *, integer *, integer *, integer *, real *, 
	    integer *, integer *, real *, integer *, ftnlen, ftnlen, ftnlen), 
...
/* Subroutine */ int sprcn2_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *side, char *uplo, integer *m, integer *n, real *alpha, 
	integer *lda, integer *ldb, real *beta, integer *ldc, ftnlen 
	sname_len, ftnlen side_len, ftnlen uplo_len)
{
    /* Format strings */
    static char fmt_9995[] = "(1x,i6,\002: \002,a12,\002(\002,a14,\002,\002,"
	    "a14,\002,\002,a14,\002,\002)";
...
/* Subroutine */ int schk3_(char *sname, real *eps, real *thresh, integer *
	...
	ct, real *g, real *c__, integer *iorder, ftnlen sname_len)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int cstrmm_(integer *, char *, char *, char *, 
	    ...
	    integer *, ftnlen, ftnlen, ftnlen, ftnlen), cstrsm_(integer *, 
	    char *, char *, char *, char *, integer *, integer *, real *, 
...
/* Subroutine */ int sprcn3_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *side, char *uplo, char *transa, char *diag, integer *m,
	 integer *n, real *alpha, integer *lda, integer *ldb, ftnlen 
