...
/* Main program */ int MAIN__(void)
{
    ...
    static char snames[12*9] = "cblas_zgemm " "cblas_zhemm " "cblas_zsymm " 
	    "cblas_ztrmm " "cblas_ztrsm " "cblas_zherk " "cblas_zsyrk " "cbl"
	    "as_zher2k" "cblas_zsyr2k";
    ...
    static char fmt_9990[] = "(\002 SUBPROGRAM NAME \002,a12,\002 NOT RECOGN"
    ...
    extern /* Subroutine */ int zchk1_(char *, doublereal *, doublereal *, 
	    ...
	    *, doublecomplex *, doublecomplex *, doublereal *, doublecomplex *
	    , integer *, ftnlen), zchk4_(char *, doublereal *, doublereal *, 
	    integer *, integer *, logical *, logical *, logical *, integer *, 
	    integer *, integer *, doublecomplex *, integer *, doublecomplex *,
	     integer *, doublecomplex *, doublecomplex *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *
	    , doublecomplex *, doublecomplex *, doublecomplex *, doublereal *,
	     integer *, ftnlen), zchk5_(char *, doublereal *, doublereal *, 
	    integer *, integer *, logical *, logical *, logical *, integer *, 
	    integer *, integer *, doublecomplex *, integer *, doublecomplex *,
	     integer *, doublecomplex *, doublecomplex *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *
...
/*           Test error exits. */
	    if (tsterr) {
		cz3chke_(snames + (isnum - 1) * 12, (ftnlen)12);
		s_wsle(&io___75);
		e_wsle();
	    }
/*           Test computations. */
	...
	g, integer *iorder, ftnlen sname_len)
{
    ...
    extern /* Subroutine */ int zprcn1_(integer *, integer *, char *, integer 
	    ...
	    *, integer *, integer *, doublecomplex *, integer *, ftnlen, 
	    ftnlen, ftnlen), czgemm_(integer *, char *, char *, integer *, 
...
/* Subroutine */ int zprcn1_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *transa, char *transb, integer *m, integer *n, integer *
	...
	beta, integer *ldc, ftnlen sname_len, ftnlen transa_len, ftnlen 
	transb_len)
{
    /* Format strings */
	...
	g, integer *iorder, ftnlen sname_len)
{
    ...
    /* Builtin functions */
    integer s_cmp(char *, char *, ftnlen, ftnlen), f_rew(alist *), s_wsfe(
...
/* Subroutine */ int zprcn2_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *side, char *uplo, integer *m, integer *n, 
	doublecomplex *alpha, integer *lda, integer *ldb, doublecomplex *beta,
	 integer *ldc, ftnlen sname_len, ftnlen side_len, ftnlen uplo_len)
{
    /* Format strings */
    static char fmt_9995[] = "(1x,i6,\002: \002,a12,\002(\002,a14,\002,\002,"
	    "a14,\002,\002,a14,\002,\002)";
	...
	iorder, ftnlen sname_len)
{
    ...
    extern /* Subroutine */ int cztrmm_(integer *, char *, char *, char *, 
	    ...
	    integer *, doublecomplex *, integer *, ftnlen, ftnlen, ftnlen, 
	    ftnlen), cztrsm_(integer *, char *, char *, char *, char *, 
	    integer *, integer *, doublecomplex *, doublecomplex *, integer *,
...
L150:
    ...
    zprcn3_(ntra, &nc, sname, iorder, side, uplo, transa, diag, &m, &n, &
	    alpha, &lda, &ldb, (ftnlen)12, (ftnlen)1, (ftnlen)1, (ftnlen)1, (
	    ftnlen)1);
...
/* Subroutine */ int zprcn3_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *side, char *uplo, char *transa, char *diag, integer *m,
	 integer *n, doublecomplex *alpha, integer *lda, integer *ldb, ftnlen 
	sname_len, ftnlen side_len, ftnlen uplo_len, ftnlen transa_len, 
	ftnlen diag_len)
{
    /* Format strings */
    static char fmt_9995[] = "(1x,i6,\002: \002,a12,\002(\002,a14,\002,\002,"
	...
	g, integer *iorder, ftnlen sname_len)
{
    ...
    extern /* Subroutine */ int zprcn4_(integer *, integer *, char *, integer 
	    *, char *, char *, integer *, integer *, doublecomplex *, integer 
	    *, doublecomplex *, integer *, ftnlen, ftnlen, ftnlen), zprcn6_(
...
/* Subroutine */ int zprcn4_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *uplo, char *transa, integer *n, integer *k, 
	doublecomplex *alpha, integer *lda, doublecomplex *beta, integer *ldc,
	 ftnlen sname_len, ftnlen uplo_len, ftnlen transa_len)
{
    /* Format strings */
...
/* Subroutine */ int zprcn6_(integer *nout, integer *nc, char *sname, integer 
	...
	*alpha, integer *lda, doublereal *beta, integer *ldc, ftnlen 
	sname_len, ftnlen uplo_len, ftnlen transa_len)
{
    /* Format strings */
    static char fmt_9995[] = "(1x,i6,\002: \002,a12,\002(\002,3(a14,\002,"
	    "\002))";
	 ...
	 integer *iorder, ftnlen sname_len)
{
    ...
    extern /* Subroutine */ int czher2k_(integer *, char *, char *, integer *,
	    ...
	    integer *, ftnlen, ftnlen), czsyr2k_(integer *, char *, char *, 
	    integer *, integer *, doublecomplex *, doublecomplex *, integer *,
	     doublecomplex *, integer *, doublecomplex *, doublecomplex *, 
	    integer *, ftnlen, ftnlen);
...
/* Subroutine */ int zprcn5_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *uplo, char *transa, integer *n, integer *k, 
	doublecomplex *alpha, integer *lda, integer *ldb, doublecomplex *beta,
	 integer *ldc, ftnlen sname_len, ftnlen uplo_len, ftnlen transa_len)
{
    /* Format strings */
    static char fmt_9995[] = "(1x,i6,\002: \002,a12,\002(\002,3(a14,\002,"
	    "\002))";
