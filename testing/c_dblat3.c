...
/* Main program */ int MAIN__(void)
{
    ...
    static char snames[12*6] = "cblas_dgemm " "cblas_dsymm " "cblas_dtrmm " 
	    "cblas_dtrsm " "cblas_dsyrk " "cblas_dsyr2k";
    ...
    extern /* Subroutine */ int dchk1_(char *, doublereal *, doublereal *, 
	    ...
	    *, integer *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, integer *, ftnlen), dchk4_(char *, 
	    doublereal *, doublereal *, integer *, integer *, logical *, 
	    logical *, logical *, integer *, integer *, integer *, doublereal 
	    *, integer *, doublereal *, integer *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, ftnlen), dchk5_(char *, doublereal *, 
    ...
    doublereal thresh;
    logical rorder;
    extern /* Subroutine */ int cd3chke_(char *, ftnlen);
    integer layout;
...
/*           Test error exits. */
	    if (tsterr) {
		cd3chke_(snames + (isnum - 1) * 12, (ftnlen)12);
		s_wsle(&io___75);
		e_wsle();
	    }
/*           Test computations. */
	...
	doublereal *ct, doublereal *g, integer *iorder, ftnlen sname_len)
{
    ...
    extern /* Subroutine */ int dprcn1_(integer *, integer *, char *, integer 
	    *, char *, char *, integer *, integer *, integer *, doublereal *, 
	    ...
	    ftnlen), cdgemm_(integer *, char *, char *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, integer *, doublereal *, 
...
/* Subroutine */ int dprcn1_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *transa, char *transb, integer *m, integer *n, integer *
	...
	integer *ldc, ftnlen sname_len, ftnlen transa_len, ftnlen transb_len)
{
    /* Format strings */
...
/* Subroutine */ int dprcn3_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *side, char *uplo, char *transa, char *diag, integer *m,
	 integer *n, doublereal *alpha, integer *lda, integer *ldb, ftnlen 
