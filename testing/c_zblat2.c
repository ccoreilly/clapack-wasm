...
/* Main program */ int MAIN__(void)
{
    ...
    static char snames[12*17] = "cblas_zgemv " "cblas_zgbmv " "cblas_zhemv " 
	    "cblas_zhbmv " "cblas_zhpmv " "cblas_ztrmv " "cblas_ztbmv " "cbl"
	    "as_ztpmv " "cblas_ztrsv " "cblas_ztbsv " "cblas_ztpsv " "cblas_z"
	    "gerc " "cblas_zgeru " "cblas_zher  " "cblas_zhpr  " "cblas_zher2 "
	     "cblas_zhpr2 ";
    ...
    static char fmt_9994[] = "(\002 ABSOLUTE VALUE OF INCX OR INCY IS 0 OR G"
	    "REATER THAN \002,i2)";
    static char fmt_9993[] = "(\002 TESTS OF THE COMPLEX*16      LEVEL 2 B"
    ...
    extern /* Subroutine */ int zchk1_(char *, doublereal *, doublereal *, 
	    ...
	    , doublecomplex *, doublecomplex *, doublecomplex *, doublereal *,
	     integer *, ftnlen), zchk2_(char *, doublereal *, doublereal *, 
	    integer *, integer *, logical *, logical *, logical *, integer *, 
	    integer *, integer *, integer *, integer *, doublecomplex *, 
	    integer *, doublecomplex *, integer *, integer *, integer *, 
	    integer *, doublecomplex *, doublecomplex *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *
	    , doublecomplex *, doublecomplex *, doublecomplex *, doublereal *,
	     integer *, ftnlen), zchk3_(char *, doublereal *, doublereal *, 
	    integer *, integer *, logical *, logical *, logical *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, doublecomplex *, doublecomplex *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *
	    , doublereal *, doublecomplex *, integer *, ftnlen), zchk4_(char *
	    ...
	    doublecomplex *, doublecomplex *, doublecomplex *, doublereal *, 
	    doublecomplex *, integer *, ftnlen), zchk5_(char *, doublereal *, 
    ...
    extern /* Subroutine */ int cz2chke_(char *, ftnlen);
...
/*           Test error exits. */
	    if (tsterr) {
		cz2chke_(snames + (isnum - 1) * 12, (ftnlen)12);
		s_wsle(&io___87);
		e_wsle();
	    }
/*           Test computations. */
...
L140:
	    if (corder) {
		zchk1_(snames + (isnum - 1) * 12, &eps, &thresh, &c__6, &ntra,
...
L150:
	    if (corder) {
		zchk2_(snames + (isnum - 1) * 12, &eps, &thresh, &c__6, &ntra,
			 &trace, &rewi, &fatal, &nidim, idim, &nkb, kb, &nalf,
			 alf, &nbet, bet, &ninc, inc, &c__65, &c__2, a, aa, 
			as, x, xx, xs, y, yy, ys, yt, g, &c__0, (ftnlen)12);
	    }
...
L160:
	    if (corder) {
		zchk3_(snames + (isnum - 1) * 12, &eps, &thresh, &c__6, &ntra,
...
L170:
	    if (corder) {
		zchk4_(snames + (isnum - 1) * 12, &eps, &thresh, &c__6, &ntra,
...
L180:
	    if (corder) {
		zchk5_(snames + (isnum - 1) * 12, &eps, &thresh, &c__6, &ntra,
			 &trace, &rewi, &fatal, &nidim, idim, &nalf, alf, &
			ninc, inc, &c__65, &c__2, a, aa, as, x, xx, xs, y, yy,
			 ys, yt, g, z__, &c__0, (ftnlen)12);
	    }
...
L190:
	    if (corder) {
		zchk6_(snames + (isnum - 1) * 12, &eps, &thresh, &c__6, &ntra,
			 &trace, &rewi, &fatal, &nidim, idim, &nalf, alf, &
			ninc, inc, &c__65, &c__2, a, aa, as, x, xx, xs, y, yy,
			 ys, yt, g, z__, &c__0, (ftnlen)12);
	    }
...
/* Subroutine */ int zchk1_(char *sname, doublereal *eps, doublereal *thresh, 
	...
	*x, doublecomplex *xx, doublecomplex *xs, doublecomplex *y, 
	...
	g, integer *iorder, ftnlen sname_len)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int zmvch_(char *, integer *, integer *, 
	    ...
	    doublereal *, logical *, integer *, logical *, ftnlen);
    logical banded;
    extern /* Subroutine */ int czgbmv_(integer *, char *, integer *, integer 
	    *, integer *, integer *, doublecomplex *, doublecomplex *, 
	    integer *, doublecomplex *, integer *, doublecomplex *, 
	    doublecomplex *, integer *, ftnlen);
    char ctrans[14];
    extern /* Subroutine */ int czgemv_(integer *, char *, integer *, integer 
	    *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, 
	...
	g, integer *iorder, ftnlen sname_len)
{
    ...
    extern /* Subroutine */ int czhbmv_(integer *, char *, integer *, integer 
	    *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, 
	    integer *, doublecomplex *, doublecomplex *, integer *, ftnlen), 
	    czhemv_(integer *, char *, integer *, doublecomplex *, 
    ...
    extern logical lzeres_(char *, char *, integer *, integer *, 
	    doublecomplex *, doublecomplex *, integer *, ftnlen, ftnlen);
    extern /* Subroutine */ int czhpmv_(integer *, char *, integer *, 
...
/* Subroutine */ int zchk3_(char *sname, doublereal *eps, doublereal *thresh, 
	...
	*x, doublecomplex *xx, doublecomplex *xs, doublecomplex *xt, 
	doublereal *g, doublecomplex *z__, integer *iorder, ftnlen sname_len)
{
    /* Initialized data */
    ...
    extern logical lzeres_(char *, char *, integer *, integer *, 
	    doublecomplex *, doublecomplex *, integer *, ftnlen, ftnlen);
    extern /* Subroutine */ int cztbmv_(integer *, char *, char *, char *, 
	    integer *, integer *, doublecomplex *, integer *, doublecomplex *,
	     integer *, ftnlen, ftnlen, ftnlen);
    char transs[1];
    extern /* Subroutine */ int cztbsv_(integer *, char *, char *, char *, 
	    integer *, integer *, doublecomplex *, integer *, doublecomplex *,
	     integer *, ftnlen, ftnlen, ftnlen), cztpmv_(integer *, char *, 
	    char *, char *, integer *, doublecomplex *, doublecomplex *, 
	    integer *, ftnlen, ftnlen, ftnlen), cztrmv_(integer *, char *, 
	    char *, char *, integer *, doublecomplex *, integer *, 
	    doublecomplex *, integer *, ftnlen, ftnlen, ftnlen), cztpsv_(
	    integer *, char *, char *, char *, integer *, doublecomplex *, 
	    doublecomplex *, integer *, ftnlen, ftnlen, ftnlen), cztrsv_(
	    integer *, char *, char *, char *, integer *, doublecomplex *, 
...
/* Subroutine */ int zchk4_(char *sname, doublereal *eps, doublereal *thresh, 
	...
	*x, doublecomplex *xx, doublecomplex *xs, doublecomplex *y, 
	doublecomplex *yy, doublecomplex *ys, doublecomplex *yt, doublereal *
	g, doublecomplex *z__, integer *iorder, ftnlen sname_len)
{
    /* Format strings */
    ...
    extern /* Subroutine */ int zmvch_(char *, integer *, integer *, 
	    ...
	    integer *, doublecomplex *, doublecomplex *, integer *, 
	    doublecomplex *, doublereal *, doublecomplex *, doublereal *, 
	    doublereal *, logical *, integer *, logical *, ftnlen), czgerc_(
	    integer *, integer *, integer *, doublecomplex *, doublecomplex *,
	     integer *, doublecomplex *, integer *, doublecomplex *, integer *
	    );
    doublereal errmax;
    extern /* Subroutine */ int czgeru_(integer *, integer *, integer *, 
	    doublecomplex *, doublecomplex *, integer *, doublecomplex *, 
	...
	g, doublecomplex *z__, integer *iorder, ftnlen sname_len)
{
    ...
    extern /* Subroutine */ int zmake_(char *, char *, char *, integer *, 
	    integer *, doublecomplex *, integer *, doublecomplex *, integer *,
	     ...
	     ftnlen);
    integer nargs;
    extern /* Subroutine */ int czher_(integer *, char *, integer *, 
	    doublereal *, doublecomplex *, integer *, doublecomplex *, 
	    integer *, ftnlen);
    logical reset;
    char cuplo[14];
    integer incxs;
    extern /* Subroutine */ int czhpr_(integer *, char *, integer *, 
	    doublereal *, doublecomplex *, integer *, doublecomplex *, ftnlen)
	...
	g, doublecomplex *z__, integer *iorder, ftnlen sname_len)
{
    ...
    logical upper;
    char uplos[1];
    extern /* Subroutine */ int czher2_(integer *, char *, integer *, 
	    doublecomplex *, doublecomplex *, integer *, doublecomplex *, 
	    integer *, doublecomplex *, integer *, ftnlen), czhpr2_(integer *,
