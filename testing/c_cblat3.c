...
/* Main program */ int MAIN__(void)
{
    ...
    static char snames[12*9] = "cblas_cgemm " "cblas_chemm " "cblas_csymm " 
	    "cblas_ctrmm " "cblas_ctrsm " "cblas_cherk " "cblas_csyrk " "cbl"
	    "as_cher2k" "cblas_csyr2k";
    ...
    extern /* Subroutine */ int cchk1_(char *, real *, real *, integer *, 
	    ...
	    complex *, complex *, complex *, real *, integer *, ftnlen), 
	    ...
	    complex *, complex *, complex *, complex *, complex *, complex *, 
	    complex *, real *, integer *, ftnlen), cchk3_(char *, real *, 
	    real *, integer *, integer *, logical *, logical *, logical *, 
	    integer *, integer *, integer *, complex *, integer *, complex *, 
	    complex *, complex *, complex *, complex *, complex *, complex *, 
	    real *, complex *, integer *, ftnlen), cchk4_(char *, real *, 
	    real *, integer *, integer *, logical *, logical *, logical *, 
	    integer *, integer *, integer *, complex *, integer *, complex *, 
	    integer *, complex *, complex *, complex *, complex *, complex *, 
	    complex *, complex *, complex *, complex *, complex *, real *, 
	    integer *, ftnlen), cchk5_(char *, real *, real *, integer *, 
	    integer *, logical *, logical *, logical *, integer *, integer *, 
	    integer *, complex *, integer *, complex *, integer *, complex *, 
	    complex *, complex *, complex *, complex *, complex *, complex *, 
	    complex *, complex *, real *, complex *, integer *, ftnlen);
    logical fatal;
    ...
    real thresh;
    logical rorder;
    extern /* Subroutine */ int cc3chke_(char *, ftnlen);
    integer layout;
...
/*           Test error exits. */
	    if (tsterr) {
		cc3chke_(snames + (isnum - 1) * 12, (ftnlen)12);
		s_wsle(&io___75);
		e_wsle();
	    }
/*           Test computations. */
...
/* Subroutine */ int cchk1_(char *sname, real *eps, real *thresh, integer *
	...
	complex *cs, complex *ct, real *g, integer *iorder, ftnlen sname_len)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int cprcn1_(integer *, integer *, char *, integer 
	    *, char *, char *, integer *, integer *, integer *, complex *, 
	    ...
	    ftnlen), ccgemm_(integer *, char *, char *, integer *, integer *, 
	    integer *, complex *, complex *, integer *, complex *, integer *, 
...
/* Subroutine */ int cprcn1_(integer *nout, integer *nc, char *sname, integer 
	...
	*ldc, ftnlen sname_len, ftnlen transa_len, ftnlen transb_len)
{
    /* Format strings */
	...
	complex *cs, complex *ct, real *g, integer *iorder, ftnlen sname_len)
{
    ...
    extern /* Subroutine */ int cprcn2_(integer *, integer *, char *, integer 
	    *, char *, char *, integer *, integer *, complex *, integer *, 
	    integer *, complex *, integer *, ftnlen, ftnlen, ftnlen), cchemm_(
...
/* Subroutine */ int cprcn3_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *side, char *uplo, char *transa, char *diag, integer *m,
	 integer *n, complex *alpha, integer *lda, integer *ldb, ftnlen 
	...
	complex *cs, complex *ct, real *g, integer *iorder, ftnlen sname_len)
{
    ...
    extern /* Subroutine */ int cprcn4_(integer *, integer *, char *, integer 
	    *, char *, char *, integer *, integer *, complex *, integer *, 
	    complex *, integer *, ftnlen, ftnlen, ftnlen), cprcn6_(integer *, 
...
/* Subroutine */ int cprcn4_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *uplo, char *transa, integer *n, integer *k, complex *
	alpha, integer *lda, complex *beta, integer *ldc, ftnlen sname_len, 
...
/* Subroutine */ int cprcn6_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *uplo, char *transa, integer *n, integer *k, real *
	alpha, integer *lda, real *beta, integer *ldc, ftnlen sname_len, 
	ftnlen uplo_len, ftnlen transa_len)
{
    /* Format strings */
    static char fmt_9995[] = "(1x,i6,\002: \002,a12,\002(\002,3(a14,\002,"
...
/* Subroutine */ int cchk5_(char *sname, real *eps, real *thresh, integer *
	...
	complex *ct, real *g, complex *w, integer *iorder, ftnlen sname_len)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int cprcn5_(integer *, integer *, char *, integer 
	    *, char *, char *, integer *, integer *, complex *, integer *, 
	    integer *, complex *, integer *, ftnlen, ftnlen, ftnlen), cprcn7_(
    ...
    extern /* Subroutine */ int ccher2k_(integer *, char *, char *, integer *,
	     integer *, complex *, complex *, integer *, complex *, integer *,
	     real *, complex *, integer *, ftnlen, ftnlen), ccsyr2k_(integer *
...
/* Subroutine */ int cprcn7_(integer *nout, integer *nc, char *sname, integer 
	*iorder, char *uplo, char *transa, integer *n, integer *k, complex *
	alpha, integer *lda, integer *ldb, real *beta, integer *ldc, ftnlen 
